...
public class FindMissingScripts : EditorWindow
{
    ...
    public void OnGUI()
    {
        ...
        if (GUILayout.Button("Active Ad", GUILayout.Height(30)))
        {
            ClearLog();
#if UNITY_ANDROID
            ...
            _defineArray = _defineArray.Add("AD_ENABLE");
        ...
        if (GUILayout.Button("Remove Ad", GUILayout.Height(30)))
        {
            ClearLog();
#if UNITY_ANDROID
            var _defineAndroid = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android);
            if (_defineAndroid.Contains("AD_ENABLE"))
            {
                _defineAndroid = _defineAndroid.Replace("AD_ENABLE", "");
                var _defineArray = _defineAndroid.Split(';');
                PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android, _defineArray);
                Debug.Log(PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android));
            }
        ...
        GUILayout.BeginHorizontal();
        if (GUILayout.Button("Active Admob", GUILayout.Height(30)))
        {
            ClearLog();
#if UNITY_ANDROID
            var _defineAndroid = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android);
            var _defineArray = _defineAndroid.Split(';');
            _defineArray = _defineArray.Add("ADMOB_ENABLE");
            PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android, _defineArray);
            Debug.Log(PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android));
#endif
        }
        if (GUILayout.Button("Remove Admob", GUILayout.Height(30)))
        {
            ClearLog();
#if UNITY_ANDROID
            var _defineAndroid = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android);
            if (_defineAndroid.Contains("ADMOB_ENABLE"))
            {
                _defineAndroid = _defineAndroid.Replace("ADMOB_ENABLE", "");
                var _defineArray = _defineAndroid.Split(';');
                PlayerSettings.SetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android, _defineArray);
                Debug.Log(PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android));
            }
